...
export const Markets = () => {
  ...
  const sortedTickers = tickers?.sort((a, b) => Number(b.lastPrice) - Number(a.lastPrice));
...
function MarketRow({ market }: { market: Ticker }) {
  ...
  return (
    <tr className="cursor-pointer border-t border-baseBorderLight hover:bg-white/7 w-full text-white" onClick={() => router.push(`/trade/${market.symbol}`)}>
